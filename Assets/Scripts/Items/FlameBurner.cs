...
public class FlameBurner : MonoBehaviour
{
    ...
    public float startDelay = 0f;       // Verz�gerung beim Spielstart (f�r asynchrone Fallen)
    ...
    void OnEnable()
    {
        ...
        if (animator != null)
        {
            ...
            // NEU: Alte Trigger l�schen, damit er nicht sofort losfeuert
    ...
    IEnumerator FlameCycle()
    {
        ...
        while (true)
        {
            ...
            // Kurz warten bis Flamme gro� genug f�r Schaden
